#include "Renderer.h"
#include "Display.h"
#include "..\build2\tutorial\mysimplification\oneField.h"
...
int main()
{
    cout << "please enter 'new' if you want to run my implementaion of collapse edge else write any thing else: " << endl;
    string x;
    cin >> x;
    oneField z = oneField();
    if (x == "new")
    ...
    Renderer renderer;
    Display display("mysimplification", DISPLAY_WIDTH, DISPLAY_HEIGHT, &renderer);
